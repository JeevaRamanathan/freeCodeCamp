...
The <dfn>call stack</dfn> is a collection of function calls stored in a stack structure. When you call a function, it is added to the top or end of the stack, and when it returns, it is removed from the top / end of the stack.
